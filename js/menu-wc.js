...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">life-learning documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-244b534a2f490cf08f37f2cd8f04510f"' : 'data-target="#xs-components-links-module-AppModule-244b534a2f490cf08f37f2cd8f04510f"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-244b534a2f490cf08f37f2cd8f04510f"' :
                                            'id="xs-components-links-module-AppModule-244b534a2f490cf08f37f2cd8f04510f"' }>
                                            <li class="link">
